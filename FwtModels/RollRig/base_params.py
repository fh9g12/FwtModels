...
def base_params():
    ...
    p.alpha_0 = mf.ModelSymbol(value = 0,string = 'alpha_1')             # FWT alpha
    p.alphadot_0 = mf.ModelSymbol(value = 0,string = 'alphadot_1')       # FWT alphadot
    ...
    p.alpha_2 = mf.ModelSymbol(value = 0,string = 'alpha_1')             # FWT alpha
    p.alphadot_2 = mf.ModelSymbol(value = 0,string = 'alphadot_1')       # FWT alphadot
